...
def make_linux(program, argv=None, env=None, entry_symbol=None, symbolic_files=None, concrete_start='', pure_symbolic=False, stdin_size=STDIN_INPUT_DEFAULT_SIZE):
...
class Manticore(Eventful):
    ...
    @classmethod
    def linux(cls, path, argv=None, envp=None, entry_symbol=None, symbolic_files=None, concrete_start='', pure_symbolic=False, stdin_size=STDIN_INPUT_DEFAULT_SIZE, **kwargs):
        """
        ...
        """
        try:
            return cls(make_linux(path, argv, envp, entry_symbol, symbolic_files, concrete_start, pure_symbolic, stdin_size), **kwargs)
