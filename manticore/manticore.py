                ...
                if event_name in plugin_method_name:
                    if not plugin_method_name.endswith('_callback') :
                        if plugin_method_name.startswith('on_') or \
                           ...
                           plugin_method_name.startswith('did_'):
                            logger.warning("Plugin methods name '%s()' should end with '_callback' on plugin %s", plugin_method_name, type(plugin).__name__ )
                    if plugin_method_name.endswith('_callback') and \
                        ...
                        not plugin_method_name.startswith('did_'):
                            logger.warning("Plugin methods name '%s()' should start with 'on_', 'will_' or 'did_' on plugin %s", plugin_method_name, type(plugin).__name__)
