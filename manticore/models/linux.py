...
class Linux(Platform):
    ...
    def sys_getrlimit(self, res, rlim):
        ...
        word_width = self.current.address_bit_size / 8
        self.current.write_int(rlim, rlimit[0], self.current.address_bit_size)
        self.current.write_int(rlim+word_width, rlimit[1], self.current.address_bit_size)
