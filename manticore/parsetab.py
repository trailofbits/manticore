...
_lr_productions = [
  ...
  ('T -> UINTN','T',1,'p_basic_type','abitypes.py',151),
  ('T -> UINT','T',1,'p_basic_type','abitypes.py',152),
  ('T -> INTN','T',1,'p_basic_type','abitypes.py',153),
  ('T -> INT','T',1,'p_basic_type','abitypes.py',154),
  ('T -> ADDRESS','T',1,'p_basic_type','abitypes.py',155),
  ('T -> BOOL','T',1,'p_basic_type','abitypes.py',156),
  ('T -> FIXEDMN','T',1,'p_basic_type','abitypes.py',157),
  ('T -> UFIXEDMN','T',1,'p_basic_type','abitypes.py',158),
  ('T -> FIXED','T',1,'p_basic_type','abitypes.py',159),
  ('T -> UFIXED','T',1,'p_basic_type','abitypes.py',160),
  ('T -> BYTESM','T',1,'p_basic_type','abitypes.py',161),
  ('T -> FUNCTION','T',1,'p_basic_type','abitypes.py',162),
  ('T -> BYTES','T',1,'p_basic_type','abitypes.py',163),
  ('T -> STRING','T',1,'p_basic_type','abitypes.py',164),
  ('TL -> T','TL',1,'p_type_list_one','abitypes.py',172),
  ('TL -> T COMMA TL','TL',3,'p_type_list','abitypes.py',179),
  ('T -> LPAREN TL RPAREN','T',3,'p_tuple','abitypes.py',186),
  ('T -> LPAREN RPAREN','T',2,'p_tuple_empty','abitypes.py',193),
  ('T -> T LBRAKET RBRAKET','T',3,'p_dynamic_type','abitypes.py',200),
  ('T -> T LBRAKET NUMBER RBRAKET','T',4,'p_dynamic_fixed_type','abitypes.py',209),
]
