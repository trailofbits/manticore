...
class ManticoreEVMProp(ManticoreEVM):
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self._snapshot = None

    @ManticoreEVM.sync
    @ManticoreEVM.at_not_running
    def take_snapshot(self):
        ''' Copy/Duplicate/backup all ready states and save it in a snapshot.
        This allows to apply temporary transactions used to check properties and
        then go back to previous snapshot
        '''
