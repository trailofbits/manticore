...
class EVMTest_vmBlockInfoTest(unittest.TestCase):
    ...
    def test_timestamp(self):
        ...
        self.assertEqual(
            world.get_code(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6), unhexlify("42600055")
        )
        # check storage
        self.assertEqual(
    ...
    def test_number(self):
        ...
        self.assertEqual(
            world.get_code(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6), unhexlify("43600055")
        )
        # check storage
        self.assertEqual(
            solve(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x00)), 0x01
    ...
    def test_gaslimit(self):
        ...
        self.assertEqual(
            world.get_code(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6), unhexlify("45600055")
        )
        # check storage
        self.assertEqual(
            solve(world.get_storage_data(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6, 0x00)), 0x0F4240
        )
        # check outs
        self.assertEqual(returndata, unhexlify(""))
        # check logs
    ...
    def test_coinbase(self):
        ...
        self.assertEqual(
            world.get_code(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6), unhexlify("41600055")
        )
        # check storage
        self.assertEqual(
    ...
    def test_difficulty(self):
        ...
        self.assertEqual(
            world.get_code(0xF572E5295C57F15886F9B263E2F6D2D6C7B5EC6), unhexlify("44600055")
        )
        # check storage
        self.assertEqual(
