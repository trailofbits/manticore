...
class EVMTest_vmArithmeticTest(unittest.TestCase):
    ...
    def test_expXY_success(self):
        ...
        constraints.add(
            data
            == b""
        )
    ...
    def test_expXY(self):
        ...
        constraints.add(
            data
            == b""
        )
