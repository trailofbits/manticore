...
class EVMTest(unittest.TestCase):
    ...
    def test_calldataload1_Istanbul(self):
        """
        ...
        m.transaction(caller=0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b,
                      ...
                      value=11,
                      data=b'\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff#',
                      gas=100000000000,
                      price=12)
        for state in m.all_states:
            world = state.platform
            self.assertEqual(used_gas_plugin.used_gas, 0xa241)
            ...
            self.assertEqual(world.get_balance(0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b), 0x7ffffffffff864d9)
            ...
            self.assertEqual(world.get_balance(0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba), 0x1bc16d674ecf9b0c)
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('60013560005500'))
            # check storage
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x00), 0xffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff23)
