...
class EVMTest(unittest.TestCase):
    ...
    def test_DynamicJump_valueUnderflow_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('60016002600334565b5050600052596000f35b50600052596000f35b505050600052596000f3'))
