...
class EVMTest(unittest.TestCase):
    ...
    def test_expPowerOf256_23_Istanbul(self):
        """
        ...
        m.create_account(address=0xf572e5295c57f15886f9b263e2f6d2d6c7b5ec6,
                         ...
                         code=unhexlify('60176101000a600055601760ff0a60015560176101010a60025500'), 
                         nonce=0)
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('60176101000a600055601760ff0a60015560176101010a60025500'))
            # check storage
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x00), 0x010000000000000000000000000000000000000000000000)
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x02), 0x0118040e1bff182cd3afb8410f81a5092fd6939debfd1701)
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x01), 0xe9f63715159cc9e33a7502256eae721b304e6fea0316ff)
