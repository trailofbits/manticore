...
class EVMTest(unittest.TestCase):
    ...
    def test_BlockNumberDynamicJumpi1_jumpdest_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('60236001600a43015760015b600255'))
            # check storage
