...
class EVMTest(unittest.TestCase):
    ...
    def test_swap16_Istanbul(self):
        ...
        for state in m.all_states:
            ...
            self.assertEqual(used_gas_plugin.used_gas, 0xa05e)
            ...
            self.assertEqual(world.get_balance(0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b), 0x7ffffffffff87b7d)
            ...
            self.assertEqual(world.get_balance(0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba), 0x1bc16d674ecf8468)
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('6010600f600e600d600c600b600a60096008600760066005600460036002600160039f55'))
            # check storage
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x10), 0x01)
