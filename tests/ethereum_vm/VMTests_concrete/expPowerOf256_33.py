...
class EVMTest(unittest.TestCase):
    ...
    def test_expPowerOf256_33_Istanbul(self):
        """
        ...
        m.create_account(address=0xf572e5295c57f15886f9b263e2f6d2d6c7b5ec6,
                         ...
                         code=unhexlify('60216101000a600055602160ff0a60015560216101010a60025500'), 
                         nonce=0)
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('60216101000a600055602160ff0a60015560216101010a60025500'))
            # check storage
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x02), 0x25f3884075dd08b8fb400789097aa95df8750bd17be0d83c9a0fb7ed52102101)
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x01), 0xfb4c498e11e3f82e714be514ef024675bb48d678bd192222cd2e783d4df020ff)
