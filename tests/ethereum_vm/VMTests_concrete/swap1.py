...
class EVMTest(unittest.TestCase):
    ...
    def test_swap1_Istanbul(self):
        ...
        """
            PUSH32 0x10112233445566778899aabbccddeeff00112233445566778899aabbccddeeff
            PUSH1 0x3
            SWAP1
            SSTORE
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(used_gas_plugin.used_gas, 0xa031)
            ...
            self.assertEqual(world.get_balance(0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b), 0x7ffffffffff87d99)
            ...
            self.assertEqual(world.get_balance(0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba), 0x1bc16d674ecf824c)
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('7f10112233445566778899aabbccddeeff00112233445566778899aabbccddeeff60039055'))
            # check storage
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x10112233445566778899aabbccddeeff00112233445566778899aabbccddeeff), 0x03)
