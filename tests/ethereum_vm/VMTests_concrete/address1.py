...
class EVMTest(unittest.TestCase):
    ...
    def test_address1_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(used_gas_plugin.used_gas, 0xa02d)
            ...
            self.assertEqual(world.get_balance(0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b), 0x7ffffffffff87dc9)
            ...
            self.assertEqual(world.get_balance(0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba), 0x1bc16d674ecf821c)
            ...
            self.assertEqual(world.get_balance(0xcd1722f3947def4cf144679da39c4c32bdc35681), 0x152d02c7e14af680000b)
            self.assertEqual(world.get_code(0xcd1722f3947def4cf144679da39c4c32bdc35681), unhexlify('3060005500'))
            # check storage
            self.assertEqual(world.get_storage_data(0xcd1722f3947def4cf144679da39c4c32bdc35681, 0x00), 0xcd1722f3947def4cf144679da39c4c32bdc35681)
