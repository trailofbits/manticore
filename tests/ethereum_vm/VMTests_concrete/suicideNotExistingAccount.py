...
class EVMTest(unittest.TestCase):
    ...
    def test_suicideNotExistingAccount_Istanbul(self):
        """
        ...
        """
            PUSH20 0xaa1722f3947def4cf144679da39c4c32bdc35681
            SELFDESTRUCT
            STOP
        """
        m.create_account(address=0xf572e5295c57f15886f9b263e2f6d2d6c7b5ec6,
                         balance=100000000000000000000000, 
                         code=unhexlify('73aa1722f3947def4cf144679da39c4c32bdc35681ff00'), 
                         nonce=0)
        ...
        """
            ...
            SSTORE
        """
        m.create_account(address=0xcd1722f3947def4cf144679da39c4c32bdc35681,
                         balance=23, 
        ...
        for state in m.all_states:
            ...
            self.assertEqual(used_gas_plugin.used_gas, 0x697b)
            ...
            self.assertEqual(world.get_balance(0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b), 0x7ffffffffffb0e2c)
            ...
            # check nonce, balance, code and storage values
            self.assertEqual(world.get_nonce(0xaa1722f3947def4cf144679da39c4c32bdc35681), 0x00)
            self.assertEqual(world.get_balance(0xaa1722f3947def4cf144679da39c4c32bdc35681), 0x152d02c7e14af6800000)
            self.assertEqual(world.get_code(0xaa1722f3947def4cf144679da39c4c32bdc35681), b'')
            ...
            self.assertEqual(world.get_balance(0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba), 0x1bc16d674eccf1c4)
            ...
            # check nonce, balance, code and storage values
            self.assertEqual(world.get_nonce(0xcd1722f3947def4cf144679da39c4c32bdc35681), 0x00)
            self.assertEqual(world.get_balance(0xcd1722f3947def4cf144679da39c4c32bdc35681), 0x17)
