...
class EVMTest(unittest.TestCase):
    ...
    def test_expPowerOf256_5_Istanbul(self):
        """
        ...
        m.create_account(address=0xf572e5295c57f15886f9b263e2f6d2d6c7b5ec6,
                         ...
                         code=unhexlify('60056101000a600055600560ff0a60015560056101010a60025500'), 
                         nonce=0)
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('60056101000a600055600560ff0a60015560056101010a60025500'))
            # check storage
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x00), 0x010000000000)
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x02), 0x01050a0a0501)
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x01), 0xfb09f604ff)
