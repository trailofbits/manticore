...
class EVMTest(unittest.TestCase):
    ...
    def test_fibonacci16_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(used_gas_plugin.used_gas, 0x05d382)
            ...
            self.assertEqual(world.get_balance(0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b), 0x7fffffffffba15cd)
            ...
            self.assertEqual(world.get_balance(0x2adc25665018aa1fe0e6bc666dac8fc2697ff9ba), 0x1bc16d674f0dea18)
