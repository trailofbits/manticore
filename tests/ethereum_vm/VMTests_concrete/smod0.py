...
class EVMTest(unittest.TestCase):
    ...
    def test_smod0_Istanbul(self):
        ...
        m.create_account(address=0xf572e5295c57f15886f9b263e2f6d2d6c7b5ec6,
                         ...
                         code=unhexlify('600360000360056000030760005500'), 
                         nonce=0)
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('600360000360056000030760005500'))
            # check storage
