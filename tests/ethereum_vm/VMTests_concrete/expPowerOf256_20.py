...
class EVMTest(unittest.TestCase):
    ...
    def test_expPowerOf256_20_Istanbul(self):
        """
        ...
        m.create_account(address=0xf572e5295c57f15886f9b263e2f6d2d6c7b5ec6,
                         ...
                         code=unhexlify('60146101000a600055601460ff0a60015560146101010a60025500'), 
                         nonce=0)
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('60146101000a600055601460ff0a60015560146101010a60025500'))
            # check storage
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x00), 0x010000000000000000000000000000000000000000)
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x02), 0x0114c2872a2898bea4ec46054167a4a2f174be1401)
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x01), 0xecb99eb1063b1984b725d2e3c72b82e88cbdec01)
