...
class EVMTest(unittest.TestCase):
    ...
    def test_jumpTo1InstructionafterJump_jumpdestFirstInstruction_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_balance(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), 0x0de0b6b3a7640000)
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('5b6003565b6001600055'))
