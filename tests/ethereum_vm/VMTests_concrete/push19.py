...
class EVMTest(unittest.TestCase):
    ...
    def test_push19_Istanbul(self):
        ...
        """
            PUSH19 0xddeeff00112233445566778899aabbccddeeff
            PUSH1 0x3
            SSTORE
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('72ddeeff00112233445566778899aabbccddeeff600355'))
            # check storage
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x03), 0xddeeff00112233445566778899aabbccddeeff)
