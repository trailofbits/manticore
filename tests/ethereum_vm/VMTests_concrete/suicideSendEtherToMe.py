...
class EVMTest(unittest.TestCase):
    ...
    def test_suicideSendEtherToMe_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_balance(0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b), 0x7ffffffffffc17e4)
