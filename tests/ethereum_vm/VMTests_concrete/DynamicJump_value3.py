...
class EVMTest(unittest.TestCase):
    ...
    def test_DynamicJump_value3_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_balance(0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b), 0x7ffffffffffc25dd)
            ...
            self.assertEqual(world.get_balance(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), 0x152d02c7e14af680001b)
