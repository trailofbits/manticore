...
class EVMTest(unittest.TestCase):
    ...
    def test_expPowerOf256_22_Istanbul(self):
        """
        ...
        m.create_account(address=0xf572e5295c57f15886f9b263e2f6d2d6c7b5ec6,
                         ...
                         code=unhexlify('60166101000a600055601660ff0a60015560166101010a60025500'), 
                         nonce=0)
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('60166101000a600055601660ff0a60015560166101010a60025500'))
            # check storage
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x00), 0x0100000000000000000000000000000000000000000000)
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x02), 0x0116ed20fb041418baf4c37d91efb553dbfa9904e71601)
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x01), 0xeae1182d42dfa98cc73c3e63d280f30e3e8cfce6ea01)
