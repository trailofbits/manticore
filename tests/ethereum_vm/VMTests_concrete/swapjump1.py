...
class EVMTest(unittest.TestCase):
    ...
    def test_swapjump1_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_balance(0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b), 0x7ffffffffffc25d5)
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('600560026001600c575050005b9060016116575050005b035b0360005260016003611ff3'))
