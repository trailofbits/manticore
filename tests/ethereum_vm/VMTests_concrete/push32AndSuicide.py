...
class EVMTest(unittest.TestCase):
    ...
    def test_push32AndSuicide_Istanbul(self):
        """
        ...
        """
            PUSH32 0xff10112233445566778899aabbccddeeff00112233445566778899aabbccddee
            SELFDESTRUCT
            PUSH1 0x3
            SSTORE
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_balance(0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b), 0x7ffffffffffb0e21)
            ...
            # check nonce, balance, code and storage values
            self.assertEqual(world.get_nonce(0xbbccddeeff00112233445566778899aabbccddee), 0x00)
            self.assertEqual(world.get_balance(0xbbccddeeff00112233445566778899aabbccddee), 0x152d02c7e14af680000b)
            self.assertEqual(world.get_code(0xbbccddeeff00112233445566778899aabbccddee), b'')
