...
class EVMTest(unittest.TestCase):
    ...
    def test_jumpDynamicJumpSameDest_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('6002600401565b600360005260206000f3600656'))
