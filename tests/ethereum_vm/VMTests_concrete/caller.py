...
class EVMTest(unittest.TestCase):
    ...
    def test_caller_Istanbul(self):
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('3360005500'))
            # check storage
            self.assertEqual(world.get_storage_data(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6, 0x00), 0xa94f5374fce5edbc8e2a8697c15331677e6ebf0b)
