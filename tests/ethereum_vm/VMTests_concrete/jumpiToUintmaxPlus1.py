...
class EVMTest(unittest.TestCase):
    ...
    def test_jumpiToUintmaxPlus1_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('6001640100000009575b5b6001600155'))
