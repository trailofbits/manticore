...
class EVMTest(unittest.TestCase):
    ...
    def test_201503110346PYTHON_PUSH24_Istanbul(self):
        """
        ...
        for state in m.all_states:
            ...
            self.assertEqual(world.get_code(0x0f572e5295c57f15886f9b263e2f6d2d6c7b5ec6), unhexlify('7745414245403745f31387900a8d55'))
