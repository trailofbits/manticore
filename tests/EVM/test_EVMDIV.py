...
class EVMTest_DIV(unittest.TestCase):
    ...
    def test_DIV_46(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [7237005577332262213973186563042994240829374041602535252466099000494570602495L])
    ...
    def test_DIV_50(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [226156424291633194186662080095093570025917938800079226639565593765455331328L])
    ...
    def test_DIV_54(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [380599384721589301615542925186532036368732432L])
    ...
    def test_DIV_58(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [1809251394333065553493296640760748560207343510400633813116524750123642650623L])
    ...
    def test_DIV_59(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [113078212145816597093331040047546785012958969400039613319782796882727665664L])
    ...
    def test_DIV_63(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [190299692360794650807771462593266018184366216L])
    ...
    def test_DIV_64(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [2412335192444087404657728854347664746943124680534178417488699666831523534165L])
    ...
    def test_DIV_67(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [1206167596222043702328864427173832373471562340267089208744349833415761767082L])
    ...
    def test_DIV_68(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [75385474763877731395554026698364523341972646266693075546521864588485110442L])
    ...
    def test_DIV_72(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [126866461573863100538514308395510678789577477L])
    ...
    def test_DIV_73(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [19014759003423441022450548080640L])
    ...
    def test_DIV_76(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [9507379501711720511225274040320L])
    ...
    def test_DIV_77(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [594211218856982531951579627520L])
