...
class EVMTest_EXP(unittest.TestCase):
    ...
    def test_EXP_5(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [104454113832828984621679659393253883542637298667129925477260695573804969029359L])
    ...
    def test_EXP_32(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [97153515582439856940218076430383148080316642374323115531717460774015781538049L])
    ...
    def test_EXP_41(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [112173586448650064316584391727166410732855297644839296413224972401556225198063L])
    ...
    def test_EXP_49(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [18446744073709551616L])
    ...
    def test_EXP_50(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [57896044618658097711785492504343953926634992332820282019735360412312277710593L])
    ...
    def test_EXP_52(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [1208925819614629174706176L])
    ...
    def test_EXP_53(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [794071845499378503449051136L])
    ...
    def test_EXP_54(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [8303694420805298775410959586403913600201715917447438497573206049841934761984L])
    ...
    def test_EXP_58(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [340282366920938463463374607431768211456L])
    ...
    def test_EXP_59(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [43143988327398919500410556793212890625L])
    ...
    def test_EXP_61(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [1461501637330902918203684832716283019655932542976L])
    ...
    def test_EXP_62(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [630550095814788844423632687832745817333905738742890496L])
    ...
    def test_EXP_67(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [6277101735386680763835789423207666416102355444464034512896L])
    ...
    def test_EXP_68(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [57896044618658097712068879837772420409703173580337995947392654709187277710593L])
    ...
    def test_EXP_70(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [1766847064778384329583297500742918515827483896875618958121606201292619776L])
    ...
    def test_EXP_71(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [17084401304090163016086072004374689170541683170424114643147834605304589320192L])
    ...
    def test_EXP_77(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [42192513242301740010671492996252704544191162524312342410321251717326910681089L])
