...
#Taken from folder /home/felipe/Projects/manticore/tests/auto/tests/VMTests/vmPerformance
import struct
import unittest
import json
import os
...
class EVMTest_vmPerformance(unittest.TestCase):
    ...
    def test_loop_exp_8b_100k(self):
        '''
            ...
            sha256sum: 1a556f34bd1e68cb3ddf06724f83d6743b9e642ada4338a754579fbdc121b085
            Code: PUSH1 0x60
                  PUSH1 0x40
                  MSTORE
                  PUSH1 0xe0
        ...
        # test spent gas
        self.assertEqual(new_vm.gas, 999985499780)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_exp_2b_100k(self):
        '''
            ...
            sha256sum: be031ca8783e4c21a2fe4e3f3f4c4cefa29df43faf9485a25237a3f61c96d4be
            Code: PUSH1 0x60
                  PUSH1 0x40
                  MSTORE
                  PUSH1 0xe0
        ...
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 999991499780)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_divadd_unr100_10M(self):
        '''
            ...
            sha256sum: 804324467b7eda1f62b7f3a4fdf748c66bb9ee00f7336634d35cda92ee6d0ab6
            Code: 
        '''    
        ...
        # test spent gas
        self.assertEqual(new_vm.gas, 999464799656)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_divadd_10M(self):
        '''
            ...
            sha256sum: a9be35c035687fa22dcc27b4b82b7fb3fd42c765fb7ead27317100665b341f10
            Code: 
        '''    
        ...
        # test spent gas
        self.assertEqual(new_vm.gas, 999109999719)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_exp_32b_100k(self):
        '''
            ...
            sha256sum: b17b28e790cc57aa0f075f22828022e71a904a978cf3d5dc01428f62aa618b9a
            Code: PUSH1 0x60
                  PUSH1 0x40
                  MSTORE
                  PUSH1 0xe0
        ...
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 999961499780)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_manyFunctions100(self):
        '''
            ...
            sha256sum: 29ae501c147ccc3640fa20eefed1bb17f48d6935062e68b6337fe9ec68ae1477
            Code: PUSH1 0xe0
                  PUSH1 0x2
                  EXP
                  PUSH1 0x0
        ...
        # test spent gas
        self.assertEqual(new_vm.gas, 71600)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_exp_nop_1M(self):
        '''
            ...
            sha256sum: e6ae749905c07ef0969a8fcd3f64d216264e1b5ca42ce50c22f6f60d64e59287
            Code: PUSH1 0x60
                  PUSH1 0x40
                  MSTORE
                  PUSH1 0xe0
        ...
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 999955999738)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_exp_4b_100k(self):
        '''
            ...
            sha256sum: 628e698141b9b13746b3ee66c0aac3674158d703010edab876e080ff613ce2a7
            Code: PUSH1 0x60
                  PUSH1 0x40
                  MSTORE
                  PUSH1 0xe0
        ...
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 999989499780)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_fibonacci10(self):
        '''
            ...
            sha256sum: 42fc09287edbc179855e408d24a0d26e5d225615247644a7868f201a592bd2ba
            Code: PUSH1 0xe0
                  PUSH1 0x2
                  EXP
                  PUSH1 0x0
        ...
        # test spent gas
        self.assertEqual(new_vm.gas, 79922)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_fibonacci16(self):
        '''
            ...
            sha256sum: 210e6be0690faa2d4721ddb452add4b1cc7f72db05371a3931d2a7083bb17be1
            Code: PUSH1 0xe0
                  PUSH1 0x2
                  EXP
                  PUSH1 0x0
        ...
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 99639418)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_ackermann31(self):
        '''
            ...
            sha256sum: b0db9094378e90043ac7f07f479e20083ae998c9ab8aa4cfe83c47d086fbabec
            Code: PUSH1 0xe0
                  PUSH1 0x2
                  EXP
                  PUSH1 0x0
        ...
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 88225)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_mulmod_2M(self):
        '''
            ...
            sha256sum: 6687467a5d37a781e6c0746643fe4ee7471f6561b96d0979c9dbf5c72ae45e14
            Code: 
        '''    
        ...
        # test spent gas
        self.assertEqual(new_vm.gas, 999867999745)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_add_10M(self):
        '''
            ...
            sha256sum: 702f558164bea154362590bbff4f1edb799035ceb696d4fae7e71ce797234204
            Code: 
        '''    
        ...
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 999439999705)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_exp_1b_1M(self):
        '''
            ...
            sha256sum: 745ac2698d881f8ce69534796c954f812acaefd70b85225643af64576c2fcf06
            Code: PUSH1 0x60
                  PUSH1 0x40
                  MSTORE
                  PUSH1 0xe0
        ...
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 999924999780)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_exp_16b_100k(self):
        '''
            ...
            sha256sum: 6e74e7db04e0397a64140e4615605fddd2ab8c7479a879d7a00ea6ae9e0b8a7c
            Code: PUSH1 0x60
                  PUSH1 0x40
                  MSTORE
                  PUSH1 0xe0
        ...
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 999977499780)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_ackermann32(self):
        '''
            ...
            sha256sum: b5c5de996aa6b484e4398d782672ede1ab1624d38f1ea752259f6b6dbfd0b53f
            Code: PUSH1 0xe0
                  PUSH1 0x2
                  EXP
                  PUSH1 0x0
        ...
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 40600)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_loop_mul(self):
        '''
            ...
            sha256sum: 4de86aa6f13a3b8979d1eebbd44863b6718481f8dd2af8bb9912a971a46d2ba1
            Code: PUSH1 0x60
                  PUSH1 0x40
                  MSTORE
                  PUSH1 0xe0
        ...
        self.assertEqual(world.get_balance(account_address), 100000000000000000000000)
        #check code
        self.assertEqual(world.get_code(account_address), unhexlify(''))
        # test spent gas
        self.assertEqual(new_vm.gas, 999881510690)
        #check callcreates
        #check refund
        #check logs
    ...
    def test_ackermann33(self):
        '''
            ...
            sha256sum: 0f82427807135559391d40e6c8645db1a8b2bf3e671724cd5a3ccbf7639b0473
            Code: PUSH1 0xe0
                  PUSH1 0x2
                  EXP
                  PUSH1 0x0
