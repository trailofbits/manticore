...
#Taken from folder /home/felipe/Projects/manticore/tests/auto/tests/VMTests/vmSystemOperations
import struct
import unittest
import json
import os
...
class EVMTest_vmSystemOperations(unittest.TestCase):
    ...
    def test_return1(self):
        ...
        world.create_account(address=0xcd1722f3947def4cf144679da39c4c32bdc35681,
                             balance=23,
                             code=unhexlify('603760005360005160005560026000f3'),
                            )
    ...
    def test_return2(self):
        ...
        world.create_account(address=0xcd1722f3947def4cf144679da39c4c32bdc35681,
                             balance=23,
                             code=unhexlify('603760005360005160005560216000f3'),
                            )
        address = 0xcd1722f3947def4cf144679da39c4c32bdc35681
        price = 0x5af3107a4000
        data = unhexlify('aa')
    ...
    def test_suicideNotExistingAccount(self):
        ...
        world.create_account(address=0xf572e5295c57f15886f9b263e2f6d2d6c7b5ec6,
                             ...
                             code=unhexlify('73aa1722f3947def4cf144679da39c4c32bdc35681ff'),
                            )
        world.create_account(address=0xcd1722f3947def4cf144679da39c4c32bdc35681,
                             balance=23,
    ...
    def test_return0(self):
        ...
        world.create_account(address=0xcd1722f3947def4cf144679da39c4c32bdc35681,
                             balance=23,
                             code=unhexlify('603760005360005160005560016000f3'),
                            )
        address = 0xcd1722f3947def4cf144679da39c4c32bdc35681
        price = 0x5af3107a4000
        data = unhexlify('aa')
