...
class EVMTest_OR(unittest.TestCase):
    ...
    def test_OR_32(self):
            ...
            self.assertEqual(last_exception, None)
            self.assertEqual(new_vm.pc, 1)
            self.assertEqual(new_vm.stack, [57896044618658097711785492504343953926634992332820282019728792003956564819967])
