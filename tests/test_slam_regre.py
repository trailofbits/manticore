...
class CPUTest(unittest.TestCase):
    ...
    def test_PUNPCKHDQ_1(self):
        ...
        mem[0x00419c43] = b'f'
        mem[0x00419c44] = b'A'
        mem[0x00419c45] = b'\x0f'
        mem[0x00419c46] = b'j'
        mem[0x00419c47] = b'\xc0'
        cpu.XMM0 = 0x4e0000004c0000004a00000048
        cpu.XMM8 = 0x0
        cpu.RIP = 0x419c43
        cpu.execute()

        self.assertEqual(mem[0x419c43], b'f')
        self.assertEqual(mem[0x419c44], b'A')
        self.assertEqual(mem[0x419c45], b'\x0f')
        self.assertEqual(mem[0x419c46], b'j')
        self.assertEqual(mem[0x419c47], b'\xc0')
    ...
    def test_PUNPCKHQDQ_1(self):
        ...
        mem.mmap(0x00419000, 0x1000, 'rwx')
        mem[0x00419c71] = b'f'
        mem[0x00419c72] = b'\x0f'
        mem[0x00419c73] = b'm'
        mem[0x00419c74] = b'\xc9'
        cpu.XMM1 = 0x6cbae800000000006cbad8
        cpu.RIP = 0x419c71
        cpu.execute()

        self.assertEqual(mem[0x419c71], b'f')
        self.assertEqual(mem[0x419c72], b'\x0f')
        self.assertEqual(mem[0x419c73], b'm')
        self.assertEqual(mem[0x419c74], b'\xc9')
    ...
    def test_PUNPCKHQDQ_11(self):
        ...
        mem.mmap(0x00419000, 0x1000, 'rwx')
        mem[0x00419c88] = b'm'
        mem[0x00419c89] = b'\xc0'
        mem[0x00419c86] = b'f'
        mem[0x00419c87] = b'\x0f'
        cpu.XMM0 = 0x6cba8800000000006cba78
        cpu.RIP = 0x419c86
        cpu.execute()

        self.assertEqual(mem[0x419c88], b'm')
        self.assertEqual(mem[0x419c89], b'\xc0')
        self.assertEqual(mem[0x419c86], b'f')
        self.assertEqual(mem[0x419c87], b'\x0f')
    ...
    def test_PUNPCKLBW_1(self):
        ...
        mem[0x004668ac] = b'f'
        mem[0x004668ad] = b'\x0f'
        mem[0x004668ae] = b'`'
        mem[0x004668af] = b'\xc9'
        cpu.XMM1 = 0x2f
        cpu.RIP = 0x4668ac
        cpu.execute()

        self.assertEqual(mem[0x4668ac], b'f')
        self.assertEqual(mem[0x4668ad], b'\x0f')
        self.assertEqual(mem[0x4668ae], b'`')
        self.assertEqual(mem[0x4668af], b'\xc9')
    ...
    def test_PUNPCKLDQ_1(self):
        ...
        mem[0x00419c48] = b'f'
        mem[0x00419c49] = b'A'
        mem[0x00419c4a] = b'\x0f'
        mem[0x00419c4b] = b'b'
        mem[0x00419c4c] = b'\xc8'
        cpu.XMM8 = 0x0
        cpu.XMM1 = 0xa6000000a4000000a2000000a0
        cpu.RIP = 0x419c48
        cpu.execute()

        self.assertEqual(mem[0x419c48], b'f')
        self.assertEqual(mem[0x419c49], b'A')
        self.assertEqual(mem[0x419c4a], b'\x0f')
        self.assertEqual(mem[0x419c4b], b'b')
        self.assertEqual(mem[0x419c4c], b'\xc8')
        self.assertEqual(cpu.XMM8, 0)
    ...
    def test_PUNPCKLQDQ_1(self):
        ...
        mem.mmap(0x00419000, 0x1000, 'rwx')
        mem[0x00419c82] = b'f'
        mem[0x00419c83] = b'\x0f'
        mem[0x00419c84] = b'l'
        mem[0x00419c85] = b'\xc8'
        cpu.XMM0 = 0x6cbfc800000000006cbfb8
        cpu.XMM1 = 0x6cbfc800000000006cbfb8
        cpu.RIP = 0x419c82
        cpu.execute()

        self.assertEqual(mem[0x419c82], b'f')
        self.assertEqual(mem[0x419c83], b'\x0f')
        self.assertEqual(mem[0x419c84], b'l')
        self.assertEqual(mem[0x419c85], b'\xc8')
    ...
    def test_PUNPCKLQDQ_10(self):
        ...
        cpu = AMD64Cpu(mem)
        mem.mmap(0x00419000, 0x1000, 'rwx')
        mem[0x00419c70] = b'\xc1'
        mem[0x00419c6c] = b'f'
        mem[0x00419c6d] = b'D'
        mem[0x00419c6e] = b'\x0f'
        mem[0x00419c6f] = b'l'
        ...
        self.assertEqual(mem[0x419c70], b'\xc1')
        self.assertEqual(mem[0x419c6c], b'f')
        self.assertEqual(mem[0x419c6d], b'D')
        self.assertEqual(mem[0x419c6e], b'\x0f')
        self.assertEqual(mem[0x419c6f], b'l')
    ...
    def test_PUNPCKLWD_1(self):
        ...
        mem.mmap(0x00466000, 0x1000, 'rwx')
        mem[0x004668b8] = b'a'
        mem[0x004668b9] = b'\xc9'
        mem[0x004668b6] = b'f'
        mem[0x004668b7] = b'\x0f'
        cpu.XMM1 = 0x2f2f
        cpu.RIP = 0x4668b6
        cpu.execute()

        self.assertEqual(mem[0x4668b8], b'a')
        self.assertEqual(mem[0x4668b9], b'\xc9')
        self.assertEqual(mem[0x4668b6], b'f')
        self.assertEqual(mem[0x4668b7], b'\x0f')
