...
class IntegrationTest(unittest.TestCase):
    ...
    def testArgumentsAssertions(self):
        testArgumentsAssertionsAux('arguments_linux_amd64', 'arguments_linux_amd64_visited.txt')

    def testArgumentsAssertionsArmv7(self):
        testArgumentsAssertionsAux('arguments_linux_armv7', 'arguments_linux_armv7_visited.txt')
