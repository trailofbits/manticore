...
# The WABT release is outdated so we can't just download it as of Sep 2019
...
wget -nc -nv -O wabt.tgz -c https://github.com/WebAssembly/wabt/releases/download/1.0.11/wabt-1.0.11-linux.tar.gz
