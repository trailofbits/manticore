...
class EVMTest_SDIV(unittest.TestCase):
    ...
    def test_SDIV_67(self):
        ...
        self.assertEqual(
            new_vm.stack,
            [1206167596222043702328864427173832373471562340267089208744349833415761767082],
        )
    ...
    def test_SDIV_68(self):
        ...
        self.assertEqual(
            new_vm.stack,
            [75385474763877731395554026698364523341972646266693075546521864588485110442],
        )
